...
def test_database_operations():
    ...
    try:
        ...
        logging.info(f"All titles: {titles}")
        ...
        logging.info(f"Titles with 'programming' tag: {tagged_titles}")
        ...
        if tagged_docs[0]['title'] != "Python Programming":
            raise AssertionError("Retrieved document has incorrect title")
        logging.info(f"Documents with 'programming' tag: {tagged_docs}")
        ...
        logging.info(f"Search results for 'versatile': {search_results}")
        ...
        logging.info(f"Retrieved updated document: {updated_doc}")
        ...
        logging.info("Verified document deletion")
